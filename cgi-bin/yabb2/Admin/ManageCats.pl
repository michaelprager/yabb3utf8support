...
$managecatsplver = 'YaBB 2.4 $Revision$';
...
<table border="0" align="center" cellspacing="1" cellpadding="4" width="100%">~;
  ...
  <tr>
    ...
    <td class="windowbg" align="right" valign="middle"><label for="theid$i"><b>$admin_txt{'61a'}:</b></label></td>
    <td class="windowbg2" valign="middle">~;
		if ($INFO{"action"} eq "catscreen") {
			$yymain .= qq~<br /><input type="hidden" name="theid$i" id="theid$i" value="$id" />$id<br /><br />~;
		} else {
			$yymain .= qq~<br /><input type="text" name="theid$i" id="theid$i" value="$id" /><br /><br />~;
		}
		$yymain .= qq~
    </td>
    ...
    <td class="windowbg" align="right" valign="middle"><label for="name$i"><b>$admin_txt{'68'}:</b></label></td>
    <td class="windowbg2"><br /><input type="text" name="name$i" id="name$i" value="$curcatname" size="40" /><br /><br /></td>
  </tr><tr>
    <td class="windowbg" align="right" valign="middle"><label for="catimage$i"><b>$admin_txt{'64b2'}:</b></label></td>
