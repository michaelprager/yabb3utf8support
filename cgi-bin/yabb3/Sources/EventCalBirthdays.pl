...
sub cal_birthdaylist {
	...
	if (!$view_January)   { $no_birthday_found .= qq~• $var_cal{'calmon_01'} ~;  $no_bd_found = 1;}
	if (!$view_February)  { $no_birthday_found .= qq~• $var_cal{'calmon_02'} ~;  $no_bd_found = 1;}
	if (!$view_March)     { $no_birthday_found .= qq~• $var_cal{'calmon_03'} ~;  $no_bd_found = 1;}
	if (!$view_April)     { $no_birthday_found .= qq~• $var_cal{'calmon_04'} ~;  $no_bd_found = 1;}
	if (!$view_May)       { $no_birthday_found .= qq~• $var_cal{'calmon_05'} ~;  $no_bd_found = 1;}
	if (!$view_June)      { $no_birthday_found .= qq~• $var_cal{'calmon_06'} ~;  $no_bd_found = 1;}
	if (!$view_July)      { $no_birthday_found .= qq~• $var_cal{'calmon_07'} ~;  $no_bd_found = 1;}
	if (!$view_August)    { $no_birthday_found .= qq~• $var_cal{'calmon_08'} ~;  $no_bd_found = 1;}
	if (!$view_September) { $no_birthday_found .= qq~• $var_cal{'calmon_09'} ~;  $no_bd_found = 1;}
	if (!$view_October)   { $no_birthday_found .= qq~• $var_cal{'calmon_10'} ~;  $no_bd_found = 1;}
	if (!$view_November)  { $no_birthday_found .= qq~• $var_cal{'calmon_11'} ~;  $no_bd_found = 1;}
	if (!$view_December)  { $no_birthday_found .= qq~• $var_cal{'calmon_12'} ~;  $no_bd_found = 1;}
